...
export const PerformanceTabItemCard: React.FC<Props> = ({ item, subtitle }) => (
  <div className={styles.container}>
      ...
      <div className={styles.tableTitleText}>{getCardTitle(item, subtitle)}</div>
    </div>
        <div className={styles.mobileCard}>
      <div className={styles.mobileCardText}>
              <div className={styles.mobileCardTextKey}>All Trades</div>
                <div className={styles.mobileCardTextValue}>{item.all}</div>
            </div>
      <div className={styles.mobileCardText}>
                <div className={styles.mobileCardTextKey}>Long Trades</div>
              <div className={styles.mobileCardTextValue}>{item.long}</div>
            </div>
            <div className={styles.mobileCardText}>
            <div className={styles.mobileCardTextKey}>Short Trades</div>
