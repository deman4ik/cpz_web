...
const _Modals: React.FC<Props> = ({ visibleModal, width, setVisibleModal, code }) => {
    ...
    return (
        <>
            ...
            <Modal
                ...
                onClose={handleSetVisible}
                title={titleModal}>
                <ActionRobotModal type={visibleModal.type} setTitle={setTitleModal} onClose={handleSetVisible} />
            </Modal>
        </>
    );
};
