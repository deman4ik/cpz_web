      ...
      <div className={styles.robotStatsCol}>
        { isUserRobot ? (
          <div className={styles.robotStatsRow}>
            ...
            <div className={styles.robotStatsValue}>
              {capitalize(robotData.user_robots.status)}
            </div>
          </div>
        ) : null}
        {((!isUserRobot && activeDays(robotData) !== null) || (isUserRobot && robotData.user_robots.status === 'started')) ? (
          <div className={styles.robotStatsRow}>
            <div className={styles.robotStatsLabel}>
              {isUserRobot ? 'Started' : 'Active'}&nbsp;
            </div>
            <div className={styles.robotStatsValue}>
