...
// icons
import { RobotIcon, MultiLineChartIcon, SettingsIcon, TelegramIcon } from "assets/icons/svg";
...
export const STEPS_CARDS: Array<stepsCard> = [
    ...
    {
        title: "Learn how to create and configure сryptocurrency exchange API Keys with your Cryptuoso Account",
        icon: "apiKey",
